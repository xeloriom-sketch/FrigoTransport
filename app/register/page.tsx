...
export default function RegisterPage() {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-bg-main" style={{ letterSpacing: '-0.01em', padding: 'max(16px, env(safe-area-inset-top)) max(16px, env(safe-area-inset-right)) max(16px, env(safe-area-inset-bottom)) max(16px, env(safe-area-inset-left))' }}>
